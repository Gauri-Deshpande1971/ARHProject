...
namespace Core.Interfaces
{
    public interface IMastersService
    {
      ...
      //  Task<bool> DeleteDocumentAsync(string PhyFilename);
        ...
        Task<IReadOnlyList<SessionSetup>> GetSessionsAsync(AppUser appUser);
        Task<SessionSetup> GetActiveSessionAsync(AppUser appUser);
        Task<IReadOnlyList<SessionDoctors>> GetSessionDoctorsAsync(AppUser appUser, int id);
        ...
        Task<IReadOnlyList<SessionDispenseTeam>> GetSessionDispenseTeamAsync(AppUser appUser, int id);
